...
const TeamMembersView = () => {
  ...
  const fetchEmployees = async (page) => {
    ...
    try {
      ...
      const res = await axiosClient.get(`/api/admin/team/get-team-members?${params.toString()}`, { silent: true })
  ...
  const deleteEmployees = () => {
    require2FA(async () => {
      try {
        await axiosClient.post('/api/admin/employees/delete-employees', { data: [...selectedIds] }, { silent: true })
